...
func TestTypeName(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "array type", arg: reflect.TypeOf([3]int{1, 2, 3}), want: "[3]int"},
		{name: "slice type", arg: reflect.TypeOf([]int{1, 2, 3}), want: "[]int"},
		{name: "map type", arg: reflect.TypeOf(map[string]int{"a": 1, "b": 2}), want: "map[string]int"},
